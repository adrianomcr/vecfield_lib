...
% M1 = dlmread('./../log_files/states.txt'); 
% M2 = dlmread('./../log_files/controls.txt');
% M3 = dlmread('./../log_files/acro_cmd.txt');
% M4 = dlmread('./../log_files/sensors.txt');
...
figure(100)
plot3(0,0,0,'k')
set(100,'Position',[840   180   560   420])
view(30,30)
hold on
